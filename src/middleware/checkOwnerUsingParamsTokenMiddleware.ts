...
const checkOwnerUsingParamsTokenMiddleware: RequestHandler = async (req: Request, res: Response, next: NextFunction) => {
    if (res.locals.skipAccessCheck) return next(); 
...
export {checkOwnerUsingParamsTokenMiddleware}